              ...
              return (
                <Card key={index} className="bg-card">
                  <CardContent className="flex flex-col items-center mt-5 rounded-lg shadow-xl">
                    ...
                    <CardDescription className="font-bold mt-5">
                      {habilidade}
                    </CardDescription>
