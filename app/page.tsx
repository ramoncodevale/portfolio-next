        ...
        <Card>
          <CardContent>
            ...
            <div className="flex items-center gap-3 mt-7">
              ...
              >
                <Button className="rounded-md font-bold text-sm p-5 hover:bg-secondary transition-colors">
                  Visualizar CV
                </Button>
              </Link>
              <Link
              ...
              >
                <Button
                  className="w-full bg-primary rounded-lg font-bold text-sm p-5 hover:bg-secondary transition-colors"
                >
